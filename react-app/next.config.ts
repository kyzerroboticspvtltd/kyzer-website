...
const securityHeaders = [
  {
    ...
    value: [
      "default-src 'self'",
      // Scripts: own origin + inline scripts (admin panel, shop) + Cashfree SDK + SheetJS + jsPDF + Three.js
      "script-src 'self' 'unsafe-inline' https://sdk.cashfree.com https://cdn.sheetjs.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://apis.google.com https://www.gstatic.com",
