    ...
    const html = `
      <div style="font-family:sans-serif;max-width:600px;margin:auto;">
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr><td style="padding:8px;color:#888;">Phone</td><td style="padding:8px;">${esc(phone) || '—'}</td></tr>
          <tr style="background:#f9f9f9;"><td style="padding:8px;color:#888;">Subject</td><td style="padding:8px;">${esc(subject) || '—'}</td></tr>
        </table>
