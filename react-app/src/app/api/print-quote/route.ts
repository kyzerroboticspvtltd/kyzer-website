  ...
  try {
    ...
    const adminHtml = `
      <div style="font-family:sans-serif;max-width:600px;margin:auto;">
        ...
        <p style="color:#888;font-size:13px;">Order ID: <strong style="color:#111;">${esc(o.id) || '—'}</strong></p>
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr><td style="padding:7px 8px;color:#888;">Phone</td><td style="padding:7px 8px;">${esc(o.phone) || '—'}</td></tr>
          <tr style="background:#f9f9f9;"><td style="padding:7px 8px;color:#888;">Company</td><td style="padding:7px 8px;">${esc(o.company) || '—'}</td></tr>
          <tr><td style="padding:7px 8px;color:#888;">Ship to</td><td style="padding:7px 8px;">${esc(shippingFull) || '—'}</td></tr>
        </table>
        <h3 style="margin:20px 0 8px;border-bottom:1px solid #eee;padding-bottom:6px;">Print Configuration</h3>
        <table style="width:100%;border-collapse:collapse;">
          <tr><td style="padding:7px 8px;color:#888;width:130px;">Material</td><td style="padding:7px 8px;">${esc(o.material) || '—'}</td></tr>
          <tr style="background:#f9f9f9;"><td style="padding:7px 8px;color:#888;">Quality</td><td style="padding:7px 8px;">${esc(o.quality) || '—'}</td></tr>
          <tr><td style="padding:7px 8px;color:#888;">Infill</td><td style="padding:7px 8px;">${esc(o.infill) || '—'}</td></tr>
          <tr style="background:#f9f9f9;"><td style="padding:7px 8px;color:#888;">Colour</td><td style="padding:7px 8px;">${esc(o.colour) || '—'}</td></tr>
          <tr><td style="padding:7px 8px;color:#888;">Support</td><td style="padding:7px 8px;">${esc(o.support) || '—'}</td></tr>
          <tr style="background:#f9f9f9;"><td style="padding:7px 8px;color:#888;">Quantity</td><td style="padding:7px 8px;">${esc(o.quantity) || '—'}</td></tr>
          <tr><td style="padding:7px 8px;color:#888;">Dimensions</td><td style="padding:7px 8px;">${esc(o.dimensions) || '—'}</td></tr>
          ...
          <tr style="background:#fff3e8;"><td style="padding:9px 8px;color:#888;font-weight:700;">Est. Total</td><td style="padding:9px 8px;font-weight:700;color:#FF8C35;font-size:16px;">₹${esc(o.estimatedTotal) || '—'}</td></tr>
        </table>
      ...
      <div style="font-family:sans-serif;max-width:600px;margin:auto;padding:20px;">
        ...
        <div style="background:#fff;border:1px solid #eee;border-top:none;padding:24px 28px;border-radius:0 0 12px 12px;">
          ...
          <table style="width:100%;border-collapse:collapse;margin:16px 0;font-size:13px;background:#f9f9f9;border-radius:8px;">
            <tr><td style="padding:8px 12px;color:#888;">Material</td><td style="padding:8px 12px;font-weight:500;">${esc(o.material) || '—'}</td></tr>
            <tr><td style="padding:8px 12px;color:#888;">Quantity</td><td style="padding:8px 12px;font-weight:500;">${esc(o.quantity) || '—'}</td></tr>
            ...
            <tr style="background:#fff3e8;"><td style="padding:10px 12px;color:#888;font-weight:700;">Est. Total</td><td style="padding:10px 12px;font-weight:700;color:#FF8C35;font-size:15px;">₹${esc(o.estimatedTotal) || '—'}</td></tr>
          </table>
          <p style="font-size:13px;color:#888;"><strong>Order ref:</strong> ${esc(o.id) || '—'}</p>
    ...
    await sendMail({
      to: NOTIFY_EMAIL(),
      subject: `[Kyzer 3D] ${esc(o.name)} — ${esc(o.material) || ''} · ₹${esc(o.estimatedTotal) || '?'}`,
      html: adminHtml,
    });
