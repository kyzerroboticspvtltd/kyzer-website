...
const POSTS: Record<string, {
  ...
  'industrial-automation-msme-india': {
    ...
    readTime: '7 min',
    emoji: '⚙️',
    excerpt: 'Can a small Indian factory afford automation? Real numbers — investment, payback period, and productivity gains for common MSME automation scenarios.',
    content: [
      ...
      { heading: 'The Real Cost of Not Automating', body: 'Before looking at automation costs, consider the baseline: a manual assembly line worker in Pune costs ₹15,000–₹25,000/month in wages alone, plus PF, ESI, training, and turnover costs. For repetitive, precision tasks — filling, labelling, quality inspection, pick-and-place — manual labour is also slower and more error-prone. A typical MSME running 2 shifts loses 15–25% output to quality defects and rework in manual processes.' },
