              ...
              {[
                {
                  ...
                  cta: 'Call +91 90496 95264', href: 'tel:+919049695264', accent: '#25D366',
                },
                {
                  icon: '💬', title: 'WhatsApp message',
                  desc: 'Send us a WhatsApp message describing your project. We reply within 2 hours.',
                  cta: 'WhatsApp us', href: 'https://wa.me/919049695264?text=Hi%20Kyzer%20Robotics%2C%20I%20would%20like%20a%20free%20consultation%20about%20my%20project.', accent: '#25D366',
                },
                {
                  icon: '✉️', title: 'Email consultation',
                  desc: 'Prefer email? Drop us a note at info@kyzerrobotics.com with your brief.',
                  cta: 'Email us', href: 'mailto:info@kyzerrobotics.com?subject=Free%20Consultation%20Request', accent: '#FF8C35',
                },
                {
                  ...
                  cta: 'Get a quote →', href: '/get-a-quote', accent: '#3498db',
                },
              ].map(opt => (
                <a key={opt.title} href={opt.href} target={opt.href.startsWith('http') ? '_blank' : undefined} rel="noopener"
                  ...
                  <div style={{
                    ...
                    display: 'flex', gap: 16, alignItems: 'flex-start', transition: 'border-color .2s',
                  }}
                  ...
                  onMouseLeave={e => (e.currentTarget.style.borderColor = '#1e1e1e')}>
                    ...
                    <div>
                      ...
                      <span style={{ fontSize: 13, color: opt.accent, fontWeight: 600 }}>{opt.cta}</span>
                    </div>
                  </div>
                </a>
              ))}
