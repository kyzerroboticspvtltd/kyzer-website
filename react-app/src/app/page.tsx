...
<div class="auth-overlay" id="authOverlay" onclick="closeAuthModal(event)">
  <div class="auth-modal" id="authModal">
    ...
    <div class="auth-body" style="text-align:center;padding:32px 24px;">
      <div style="font-size:40px;margin-bottom:16px;">🔐</div>
      <div style="font-size:16px;font-weight:700;color:#111;margin-bottom:8px;">Sign in with Email OTP</div>
      <div style="font-size:13px;color:#888;margin-bottom:24px;">We&apos;ll send a one-time code to your email. No password needed.</div>
      <a href="/login" style="display:block;background:#FF8C35;color:#fff;padding:13px 24px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;font-family:inherit;">
        Go to Sign In
      </a>
    </div>
  </div>
