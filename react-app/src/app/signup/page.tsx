            ...
            <div style={{ background: '#fff', borderRadius: 12, border: '1px solid rgba(0,0,0,0.09)', padding: '32px 28px' }}>
              {success ? (
                <div style={{ textAlign: 'center', padding: '12px 0' }}>
                  ...
                  <p style={{ fontSize: 14, color: '#666', marginBottom: 20 }}>We&apos;ve sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.</p>
